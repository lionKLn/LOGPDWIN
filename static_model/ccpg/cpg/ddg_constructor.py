...
def has_dd_rel(use_var: str, def_node: DDGNode) -> bool:
    ...
    if use_var == None or def_node == None:
        ...
        raise ValueError('use variable or def node is none, exit')
...
def ddg_conditional_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 3:
        ...
        raise ValueError('Conditional expression has {} children, only support 3 children.' .format(len(node_successors)))
...
def ddg_assignment_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 3:
        ...
        raise ValueError('Assignment expression has {} children, only support 3 children.' .format(len(node_successors)))
...
def ddg_binary_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 3:
        ...
        raise ValueError('Binary expression has {} children, only support 3 children'. format(len(node_successors)))
...
def ddg_unary_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Unary expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_update_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(update_expression_successors) != 2:
        ...
        raise ValueError('Update expression has {} children, only support 2 children.' .format(len(update_expression_successors)))
...
def ddg_cast_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Cast expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_pointer_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Pointer expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_sizeof_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Sizeof expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_subscript_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Subscript expression has {} children, only support 2 children.' .format(len(node_successors)))
...
def ddg_field_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Field expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_compound_literal_expression(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 2:
        ...
        raise ValueError('Compound literal expression has {} children, only support 2 children' .format(len(node_successors)))
...
def ddg_init_declarator(cfg_cpg: DiGraph, node: str) -> list:
    ...
    if len(node_successors) != 3:
        ...
        raise ValueError('Init declarator has {} children, only support 3 children' .format(len(node_successors)))
