...
def cfg_ifstatement(ast_cpg: DiGraph, node: str) -> list:
    ...
    # situation: have both then and else block
        ...
        raise ValueError('If statement has {} children, only support 3 and 5 children' .format(c_child))
...
def cfg_dostatement(ast_cpg: DiGraph, node: str) -> list:
    ...
    if len(do_statement_successors) != 4:
        ...
        raise ValueError('Do statement has {} children, only support 4 children' .format(len(do_statement_successors)))
...
def cfg_breakstatement(ast_cpg: DiGraph, node: str) -> list:
    ...
    if successors_num != 1:
        ...
        raise ValueError('Break Statement has {} children, only support one child' .format(successors_num))
...
def cfg_gotostatement(ast_cpg: DiGraph, node: str) -> list:
    ...
    if len(goto_statement_successors) != 2:
        ...
        raise ValueError('Goto statement has {} children, only support 2 children' .format(len(goto_statement_successors)))
