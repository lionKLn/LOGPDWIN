...
from tqdm import tqdm  # ✅ tqdm 引入
from torch.utils.tensorboard import SummaryWriter  # ✅ TensorBoard 引入
import time
from sklearn.metrics import precision_score  # ✅ 引入 precision_score
import os
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        print(
            f"📘 Epoch {epoch + 1} - Loss: {total_loss:.4f} - Acc: {acc * 100:.2f}% - Precision: {precision:.2f} - Recall: {recall:.2f} - F1: {f1:.2f}")
